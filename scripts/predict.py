...
from recifine.training.predict import predict_without_evaluate
...
def build_parser():
    ...
    p.add_argument("--dataset_to_predict", nargs="+", default=None,
                   help="Optional dataset subfolders to predict.")
...
def main():
    ...
    logger.debug("Prediction parameters %s", args)

    predict_data_dirs = []
    if args.dataset_to_predict:
        predict_data_dirs = args.dataset_to_predict

    base_data_dir = args.data_dir
    for data_dir in tqdm(predict_data_dirs, desc="Data_Dir:"):
        ...
        predict_without_evaluate(args, model, tokenizer, labels, pad_token_label_id, mode="test")  
