...
TASTEset1 is a recipe named-entity recognition (NER) dataset designed for fine-grained extraction of culinary entities such as **food items, quantities, units, processes, physical qualities, taste attributes**, and more from ingredient lists.
...
### Download link:
  [https://github.com/taisti/TASTEset/tree/main/data](https://github.com/taisti/TASTEset/tree/main/data)
...
## Citation
If you use the Tasteset1 dataset, please cite the original dataset authors.
