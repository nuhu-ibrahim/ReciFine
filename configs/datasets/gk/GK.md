...
1. Download the file `gk_complete_dataset.tsv` from the link above.

---

## Raw Data Format

The file `gk_complete_dataset.tsv` follows the standard CoNLL BIO format:
...
If you use the GK dataset, please cite the original dataset authors.
